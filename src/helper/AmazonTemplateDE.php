...
class AmazonTemplateDE
{
    ...
    {
        return <<<DES
<p>Onlymaker ist eine Schuhemarke,nach dem Trend herstellen wir von Hand gemachter Dameschuhe mit guenstiger Preis fuer die perfekte Schuhen mit hoeher Qualitaet.</p><p>Die Eigenheit ist Sonderanfertigung,.nach Farbe,Absatzhohe,Material und Size koenen wir die Beduefnisse der Kunden von indiciduelltaet zufrieden stellen. Wenn Sie brauchen ,Bitte kontaktieren Sie mit uns.</p><p><b>Q1:Wenn ich die Schuhe kaufen wollen,passt aber nicht.Was kann ich machen?</b></p><p>Sie koennen die Schuhe zurueck verschicken fuer Umtausch oder &nbsp;Erstattung wenn die Schuhe Ihnen nicht passen oder gefallen&nbsp;</p><p><b>Q2:Wann kann ich meine Schuhe bekommen?</b></p><p>Normalerweise dauert es in zwei Wochen ,Schneller Versand und dringend Beduerfnis sind verfuegbar und bitte kontaktieren Sie mit uns.</p><p><b>Q3:Koenne Sie mir die Schuhe nach meinem&nbsp;Wunsch anfertigen?</b></p><p>Ja,Anfertigen ist verfuegbar.Bitte kontaktieren Sie mit uns ,die Details zu uns geben.z.B.die Absatzhoehe ,Farbe und auch eine neue Schuh mit Ihrer Idee.</p><p><b>Q4:Wenn ich die Schuhe zuruecksenden wollte,wohin sollte ich verschicken?</b></p><p>Für die Retouren koennen Sie zu unserem deutschen Buero zuruecksenden.</p><p>&nbsp;Wenn Sie Fragen haben,koennen Sie zuerst uns kontaktieren,stehen wir gerne Ihnen zur Verfuegung.</p>
DES;
    }
